...
mkdir -p $dir
tar xvfz %{SOURCE0} -C $dir
ln -s xconv%{version} $dir/xconv
ln -s convsh%{version} $dir/convsh
...
* Tue Sep 10 2019  <iwi@alan-builder.novalocal> - 1.93-2.ceda
- update to 1.94 and build on CentOS7
...
%{_bindir}/xconv
%{_bindir}/convsh
%{_bindir}/xconv%{version}
%{_bindir}/convsh%{version}
%defattr(-,root,root)
%{prelink_conf}
