...
Requires: %{?scl:%{scl_prefix}}udunits = %{version}, expat-devel
%description devel
...
%doc %{_datadir}/doc/udunits/CHANGE_LOG
%doc %{_datadir}/doc/udunits/COPYRIGHT
%doc %{_datadir}/doc/udunits/README
