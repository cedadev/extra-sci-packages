...
%build
chmod 755 configure  # fix permission bug in tarball 1.8.3.1
%configure
make
...
%changelog
* Fri Sep 27 2019 Builder <builder@builder.ceda.ac.uk> - 1.8.3.1-1
- bump version and build for CentOS7 SCL
  (tried 1.8.5.1 but requires a later netCDF than in EPEL)
