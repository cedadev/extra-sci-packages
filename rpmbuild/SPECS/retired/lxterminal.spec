...
Source0:        http://downloads.sourceforge.net/sourceforge/lxde/%{_name}-%{version}.tar.xz
...
desktop-file-install --vendor="fedora"                     \
  ...
  ${RPM_BUILD_ROOT}%{_datadir}/applications/%{_name}.desktop
%find_lang %{_name}
...
%{_bindir}/%{_name}
%{_datadir}/%{_name}/
%{_datadir}/applications/fedora-%{_name}.desktop
%{_datadir}/icons/hicolor/128x128/apps/lxterminal.png
%{_mandir}/man1/%{_name}*.1.gz


%changelog
* Thu Sep 26 2019 Builder <builder@builder.ceda.ac.uk> - 0.3.2-1
- bump version and modify for SCL build
